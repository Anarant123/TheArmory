...
namespace TheArmory.Web.Services;

public class AuthSevice : BaseService<User>
{
    protected override string RootPointName => "Auth";

    public AuthSevice(IHttpClientFactory httpClientFactory,
