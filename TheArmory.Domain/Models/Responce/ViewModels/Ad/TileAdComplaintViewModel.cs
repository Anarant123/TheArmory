...
public class TileAdComplaintViewModel
{
    ...
    [JsonPropertyName("countOfViews")] public int CountOfViews { get; set; } = 0;
    ...
    [JsonPropertyName("description")] public int CountOfComplaint { get; set; }

    public TileAdComplaintViewModel()
    {
    }

    public TileAdComplaintViewModel(Database.Ad ad)
    {
        Id = ad.Id;
        Name = ad.Name;
        ...
        CountOfComplaint = ad.Complaints.Count;
    }
}